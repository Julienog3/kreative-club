...
import { RawCondition, Dict, UtilityConfig, PropertyConfig, PatternHelpers, CascadeLayers, RecipeConfig, SlotRecipeConfig, CssKeyframes, Token, StaticCssOptions, SystemStyleObject } from '@pandacss/types';
...
declare class Recipes {
    ...
    getConfig: (name: string) => SlotRecipeConfig | RecipeConfig<_pandacss_types.RecipeVariantRecord>;
...
export { AtomicRule, Breakpoints, Conditions, Recipes, Stylesheet, StylesheetContext, StylesheetOptions, Utility, assignCompositions, expandCssFunctions, expandNestedCss, extractParentSelectors, getStaticCss, isSlotRecipe, mergeCss, optimizeCss, prettifyCss, sharedHooks, toCss, toKeyframeCss };
