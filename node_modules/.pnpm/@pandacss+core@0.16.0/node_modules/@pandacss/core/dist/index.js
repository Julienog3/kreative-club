...
var Breakpoints = class {
  ...
  get ranges() {
    ...
    const values = breakpoints.flatMap((name) => {
      ...
      const down = [`${name}Down`, this.build({ max: value.min })];
...
function adjust(value) {
  const computedMax = parseFloat((0, import_shared5.toPx)(value) ?? "") - 0.05;
...
var Recipes = class {
  ...
  assignRecipe = (name, recipe) => {
    ...
    const jsx = recipe.jsx ?? [(0, import_shared10.capitalize)(name)];
