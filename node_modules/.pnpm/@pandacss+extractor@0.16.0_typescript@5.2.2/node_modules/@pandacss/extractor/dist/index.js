...
var getLiteralValue = (node, ctx) => {
  return (0, import_ts_pattern7.match)(node).with(import_ts_pattern7.P.nullish, () => void 0).when(box.isConditional, (node2) => {
    ...
    const last = node2.getStack().at(-1);
...
var unbox = (node, ctx) => {
  ...
  const raw = (0, import_ts_pattern7.match)(node).with(import_ts_pattern7.P.nullish, () => void 0).when(Array.isArray, (node2) => {
    ...
    cache.set(node2, { raw: value, conditions: _ctx.conditions, spreadConditions: _ctx.spreadConditions });
    return value;
  }).otherwise((node2) => {
